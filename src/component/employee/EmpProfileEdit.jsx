...
import { useUpdateEmployeeProfileMutation } from '../../redux/apis/employeeApi'
...
const Secound = ({ paggination, setPaggination, userData, setUserData, screen, setScreen }) => {
    const [updateProfile, { isSuccess, isError, error, isLoading }] = useUpdateEmployeeProfileMutation()
