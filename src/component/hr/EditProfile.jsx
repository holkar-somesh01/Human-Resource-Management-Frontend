...
import { useUpdateHrProfileMutation } from '../../redux/apis/hrApi'
    ...
    return <>
        ...
        <form onSubmit={formik.handleSubmit}>
            <div className="row">
                ...
                <div className='col-sm-4 my-2 d-flex gap-5'>
                    <div className='d-flex gap-3'>
                        <input
                            ...
                            className={`${formik.touched.gender && formik.errors.gender ? "is-invalid" : "form-check-input"}`}
                        />
...
const Secound = ({ paggination, setPaggination, userData, setUserData, screen, setScreen }) => {
    const [updateProfile, { isSuccess, isError, error, isLoading }] = useUpdateHrProfileMutation()
